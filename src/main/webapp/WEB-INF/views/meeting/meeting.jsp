...
<script type="text/javascript">
	...
	function check() {
		...
		if (flag) {
			...
			$("#form1").attr('action','<%=path%>/MeetingServlet?json=' + form2json("form"));
			timeForm.submit();
		}
	}
				...
				<dl class="dl-table">
					...
					<dd>
						...
						<div id="lh" style="display: none;">
							<input type="radio" name="lht" value="1" checked="checked" /> 周例会 &nbsp;&nbsp;&nbsp;&nbsp; <input
								type="radio" name="lht" value="2" /> 月例会
						</div>
						<script type="text/javascript">
							$(function() {
					...
					<dd>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" value="2"
							name="grade" <c:if test="${meeting.grade==2 }">checked="checked"</c:if>>处内会议
					</dd>
					<dt>会议类目：</dt>
					<dd>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
							type="radio" value="2" name="category"
					...
					<dt>主持人：</dt>
					<dd>
						<input class="input" type="text" id="presider" name="presider" size="35"
					...
					<dd>
						<div style="margin: 0 auto; width: 100%;">
							<div style="float: left; width: 127px; height: 100px;">
								<select id="selLeaders" multiple size="10"
									style="width: 127px; height: 97px; font-size: 9pt;">
							...
							<div style="float: right; width: 127px; height: 100px; margin-right: 400px;">
								<select id="leaders" name="leader" multiple="multiple" size="10"
									style="width: 127px; height: 97px; font-size: 9pt;">
									<c:forEach items="${fn:split(meeting.leader,',') }" var="leader">
							...
							<div style="height: 100px; text-align: center; vertical-align: middle;">
								<br />
								<input type="button" name="11" value="添加>>"
									onclick="leaderCheck('selLeaders','leaders',false)"> <br />
					...
					<dt>会议预算：</dt>
					<dd>
						<input class="input easyui-numberbox" type="text" id="budget" name="budget" size="35"
							value="${empty meeting.budget ? '0' : meeting.budget }">万元
					</dd>
					<dt>
						<em>*</em> 组织处室：
					</dt>
					...
					<dt>会议联系人：</dt>
					<dd>
						<input class="input" id="contact" name="contact" size="35" type="text"
							value="${empty meeting.contact ? '':meeting.contact}" />
					</dd>
					<dt>
						<em>*</em> 联系人电话：
					</dt>
					<dd>
						<input class="input" id="contactphone" name="contactphone" size="35" type="text"
					...
					<dd>
						<textarea rows="3" id="fdepart" name="fdepart" style="width: 550px"
							onfocus="if(this.value=='外部单位/人员'){this.value='';}"
							onblur="if(this.value==''){this.value='外部单位/人员';}">${empty meeting.fdepart ?'外部单位/人员' : meeting.fdepart }</textarea>
						<textarea rows="3" id="depart" name="depart" style="width: 550px"
							onfocus="if(this.value=='内部单位/人员'){this.value='';}"
