			...
			<table class="dtable" align="center" cellspacing="1">
				...
				<c:forEach items="${meetings }" var="mp">
					<tr>
						...
						<td width="10%" align="center">${mp.address }</td>
					...
					<td width="3%" align="center">
						<a <c:if test="${from =='m' }">href="MeetingTrainingServlet?ctrl=toUpdate&show=all&id=${mp.id }"</c:if>>修改</a> <a
							href="javascript:confirmDelete('MeetingServlet?ctrl=del&id=${mp.id }')">删除</a>
						</td> 
					</tr>
				</c:forEach>
				<tr>
